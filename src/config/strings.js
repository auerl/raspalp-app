...
export const TITLE_FRIENDS = 'Gärtner';
export const TITLE_TASKS = 'Aufträge';
...
export const USER_NOT_FOUND_ERROR = 'E-Mail oder Passwort falsch'
export const LOGIN_ERROR = 'Login fehlgeschlagen'
export const LOGIN_SUCCESS = ''

export const REGISTER_ERROR = 'Fehlerhafte Eingabe'
export const REGISTER_SUCCESS = ''

export const ALERT_TITLE = 'Warnung';
